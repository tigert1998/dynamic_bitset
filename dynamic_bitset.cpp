...
dynamic_bitset::dynamic_bitset() : _size(0) {}
...
void dynamic_bitset::_push(size_type tot, const_unit_reference u, size_type s, difference_type l)
{
    if (tot == 0)
    {
...
dynamic_bitset::dynamic_bitset(const dynamic_bitset &other, size_type s, difference_type l) : dynamic_bitset(l)
{
    size_type tot = 0, last = s;
